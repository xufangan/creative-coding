var myRec = new p5.SpeechRec('en-US'); // new P5.SpeechRec object
        ...
        function preload() {
            ...
            arnold = loadImage('Pictures/arnold.gif');
		...
		function draw() {
            ...
            let tempResult;
            tempResult = myRec.resultString.includes("I am Arnold")
            console.log(tempResult)
            if (tempResult == true){
                image(arnold, 900, 200);
				text('Amazing! You probably run laps around me', 900, 100, width, height)
            }


            tempResult = myRec.resultString.includes("next question please")
            console.log(tempResult)
            if (tempResult == true){
                image(jesus, 900, 200);
